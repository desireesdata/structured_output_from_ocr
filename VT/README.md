...
```
"1099" -----(distance : 0.00)-----> "1099"
"1764" -----(distance : 0.00)-----> "1764"
"Blaignan (Raymond)" -----(distance : 0.00)-----> "Blaignan (Raymond)"
"112" -----(distance : X)-----> <aucun match>
"448" -----(distance : 0.00)-----> "448"
"449" -----(distance : 0.00)-----> "449"
```
...
**FORMAT just page and name "modèle épuré"**. 
